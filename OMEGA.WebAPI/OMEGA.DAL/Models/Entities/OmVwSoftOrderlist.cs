...
[Keyless]
public partial class OmVwSoftOrderlist
{
    [Column("order_id")]
    ...
    [Column("order_date_new")]
    [StringLength(30)]
    [Unicode(false)]
    public string? OrderDateNew { get; set; }
    ...
    [Column("order_due_dates", TypeName = "datetime")]
    public DateTime? OrderDueDates { get; set; }
